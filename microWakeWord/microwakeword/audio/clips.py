...
class Clips:
    ...
    def __init__(
        ...
        # Load all filtered clips — use decode=False to avoid torchcodec on Windows
    ...
    def _decode_audio(self, audio_info, target_sr=16000):
        """Decode audio using soundfile, bypassing torchcodec."""
    ...
    def audio_generator(self, split: str | None = None, repeat: int = 1):
        ...
        for _ in range(repeat):
            for clip in clip_list:
                clip_audio = self._decode_audio(clip["audio"])
    ...
    def get_random_clip(self):
        ...
        clip_audio = self._decode_audio(rand_audio_entry["audio"])
